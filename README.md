...
- [War Maps conflict network](https://sjah9.github.io/war-maps-project/)
...
The Network, Graph, and 3D Network Browser share one [network visualization language](docs/NETWORK_VISUALIZATION_LANGUAGE.md). Each control deck presents seven primary command chunks, preserves the same verbs for the same operations, and moves secondary tools behind an Actions disclosure instead of giving every control equal visual weight.
