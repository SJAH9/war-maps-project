...
class WarMapsBuildTests(unittest.TestCase):
    ...
    def test_network_inputs_retain_sides_locations_and_observations(self):
        ...
        self.assertIn("else renderSVG3D()", network_source)
        ...
        self.assertIn("nodeColor(displayNodeColor)", network_source)
        ...
        self.assertIn("pullSideNeighborhood", network_source)
        ...
        self.assertEqual(network_page.count('class="network-command"'), 7)
        self.assertIn('aria-label="Network visualization controls"', network_page)
        ...
        self.assertIn('class="landing-page"', index_page)
        self.assertIn('assets/warmaps.jpg', ROOT.joinpath("web/styles.css").read_text(encoding="utf-8"))
        self.assertTrue((ROOT / "web/assets/warmaps.jpg").exists())
        ...
        self.assertIn("collisionForce", shared_model)
        ...
        self.assertIn("function visibleGraph", navigator_source)
        self.assertIn("function focus", navigator_source)
        self.assertIn("expandTen", navigator_source)
        self.assertIn("pruneDistant", navigator_source)
        self.assertIn("analyzeVisible", navigator_source)
        self.assertIn("magneticForce", navigator_source)
        self.assertIn("observation involving member state", navigator_source)
        self.assertIn("personName", navigator_source)
        self.assertIn("kindLabel", navigator_source)
        self.assertIn("updateConnections", navigator_source)
        self.assertIn("params.get('source')==='graph'", navigator_source)
        self.assertIn("shared-side participation", navigator_source)
        self.assertIn("selectedOrganizations", navigator_source)
        self.assertIn("pullNeighborhood", navigator_source)
        self.assertIn('id="navigator-register-list"', navigator_page)
        self.assertIn('id="navigator-topology"', navigator_page)
        self.assertIn("3D Network Browser", navigator_page)
        self.assertEqual(navigator_page.count('class="navigator-command'), 7)
        self.assertIn('value="human"', navigator_page)
        self.assertIn("Group by connection", navigator_page)
        self.assertIn("Emphasize hubs", navigator_page)
    ...
    def test_relationship_browser_exposes_sourced_entity_edges(self):
        ...
        self.assertIn("Minimum observed years", page)
        self.assertIn("Nation ↔ conflict", page)
        self.assertIn("Connection Register", page)
        self.assertIn("data.conflict_years", source)
        self.assertIn("Graph density", source)
        self.assertIn("forceLayout", source)
        self.assertIn("renderSVG", source)
        self.assertIn("minimum=nodeRadius(a)+nodeRadius(b)+14", source)
        self.assertIn("event.key.toLowerCase()!=='o'", source)
        self.assertIn("scene.optimize", source)
        self.assertIn('id="graph-optimize"', page)
        self.assertEqual(page.count('class="network-command'), 7)
        self.assertIn('aria-label="Network visualization controls"', page)
        ...
        self.assertIn("state.relationship='combined'", source)
        self.assertIn('value="equilibrium"', page)
        self.assertIn('value="third-party"', page)
        self.assertIn('value="barabasi"', page)
        self.assertIn('value="watts-strogatz"', page)
        self.assertIn('id="graph-browser"', page)
        self.assertIn("network-3d.html", source)
        self.assertIn("source','graph", source)
    ...
    def test_gas_map_snapshot_retains_source_scope_and_units(self):
        ...
        self.assertIn("MAX_TOWER_HEIGHT = 13", map_source)
        self.assertIn("const footprintScale = value => .28 + Math.pow(priceFraction(value),3) * 1.72", map_source)
    ...
    def test_civilian_casualty_map_uses_ged_civilian_totals(self):
        ...
        self.assertIn("reverseCountries", casualty_source)
        self.assertIn("boundsGap", casualty_source)
        ...
        self.assertNotIn('data-health-layer="mortality" checked', markup)
        self.assertNotIn('data-health-layer="lifeExpectancy" checked', markup)
        self.assertIn("activeHealth:new Set()", casualty_source)
