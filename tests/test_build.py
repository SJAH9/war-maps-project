...
class WarMapsBuildTests(unittest.TestCase):
    ...
    def test_network_inputs_retain_sides_locations_and_observations(self):
        ...
        self.assertIn("renderWarRegister", network_source)
        self.assertIn("playWarRegister", network_source)
        self.assertIn("updateFocalGraph", network_source)
        self.assertIn("previous=new Map(graph.graphData().nodes", network_source)
        self.assertIn("isolatedRegimes", network_source)
        ...
        self.assertIn("eventPosture", shared_model)
        self.assertIn("regimeCountry", shared_model)
        self.assertIn("zeroSumProxy", shared_model)
        ...
        self.assertIn("registerDates", navigator_source)
        self.assertIn("updateFocalGraph", navigator_source)
    ...
    def test_global_graph_uses_only_same_side_edges(self):
        ...
        self.assertIn('data-organization="un"', page)
        self.assertIn('data-organization="wef"', page)
        self.assertIn('id="graph-include-ungrouped"', page)
        self.assertNotIn('id="graph-organization"', page)
        self.assertIn('id="graph-rule-description"', page)
        self.assertIn("updatePageDescription", source)
        self.assertIn("linkDescription", source)
        self.assertIn("Synthetic topology has no historical interval", source)
        self.assertIn('value="organization"', page)
        self.assertIn("organizationLinks", source)
        self.assertIn("organizationMembers", source)
        self.assertIn("observedKeys.has([link.source,link.target].sort().join('\\u0000'))", source)
        self.assertIn("kind:'organization'", source)
        self.assertIn("syntheticLinks", source)
        self.assertIn("organization co-membership", source)
        self.assertIn("kind==='synthetic'", source)
        self.assertIn("selectedOrganizations", source)
        self.assertIn("organizationNodes", source)
        self.assertIn("includeUngrouped", source)
        self.assertIn("entity_member_nations", source)
        self.assertIn("entityKind:'organization'", source)
